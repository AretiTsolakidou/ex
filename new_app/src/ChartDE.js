...
const ChartDE = ({ timeseriesData }) => {
  ...
  // Make a chart for the German price to illustrate the trend over time
  return (
    <div>
      <h3 className='mt-5 mb-3 text-center'>German Price Chart</h3>
      <ResponsiveContainer width="100%" height={500}>
        <LineChart data={chartData}>
          ...
          <Line  type="monotone" dataKey="DE_Price" stroke="rgb(75, 192, 192)" name='German Price'/>
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
